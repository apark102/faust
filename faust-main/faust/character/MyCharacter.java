...
import static faust.faustmod.characterPath;
import static faust.faustmod.makeID;
...
public class MyCharacter extends CustomPlayer {
    ...
    public MyCharacter() {
        super(getNames()[0], Meta.YOUR_CHARACTER,
                ...
                new SpriterAnimation(characterPath("animation/idleani2.scml"))); //Animation
