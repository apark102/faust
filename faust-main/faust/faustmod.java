...
import faust.cards.BaseCard;
import faust.character.MyCharacter;
import faust.ui.CustomResourceRenderer;
import faust.ui.CustomResourceUI;
import faust.ui.CustomResourceRenderer;
...
public class faustmod implements
    ...
    public void receivePostInitialize() {
        ...
        BaseMod.subscribe(new CustomResourceRenderer());
    ...
    private static String checkResourcesPath() {
        String name = faustmod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        if (!resources.exists()) {
            throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                    ...
                    "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                    "\tat the top of the " + faustmod.class.getSimpleName() + " java file.");
        }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(faustmod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
